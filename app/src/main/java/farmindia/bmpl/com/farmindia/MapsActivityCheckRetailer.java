...
public class MapsActivityCheckRetailer extends AppCompatActivity
   ...
   double lat2[]={28.721461,28.100567,28.721461};
    double lng2[]={77.079054,77.122963,77.233445};
   ...
   /* private String[] mLikelyPlaceNames = new String[mMaxEntries];
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // AlertDialog.Builder alertDialog=new AlertDialog.Builder(MapsActivityCheckRetailer.this);
...
//        mMapBean.add(new MapBean("city","name","28.720844","77.107121"));
        ...
        myRef = database.getReference("onlyForGps");

        myRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot postSnapshot: dataSnapshot.getChildren()){
                    lat.add(postSnapshot.child("latitude").getValue(Double.class));
                    Toast.makeText(MapsActivityCheckRetailer.this,postSnapshot.child("latitude").getValue().toString(),Toast.LENGTH_LONG).show();
                    lng.add(postSnapshot.child("longitude").getValue(Double.class));
                }
                ...
                for (int j=0;j<lat.size();j++){
                    ...
                    Toast.makeText(getApplicationContext()," lat---> "+flat[j],Toast.LENGTH_LONG).show();
