...
public class MapsActivityCheckFarmer extends AppCompatActivity
   ...
   /* private String[] mLikelyPlaceNames = new String[mMaxEntries];
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // AlertDialog.Builder alertDialog=new AlertDialog.Builder(MapsActivityCheckFarmer.this);
...
//        mMapBean.add(new MapBean("city","name","28.720844","77.107121"));
        ...
        setContentView(R.layout.activity_maps_check_farmer);
       ...
       /* myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot postSnapshot: dataSnapshot.getChildren()){
                    ...
                    Toast.makeText(MapsActivityCheckFarmer.this,postSnapshot.child("lat").getValue().toString(),Toast.LENGTH_LONG).show();
