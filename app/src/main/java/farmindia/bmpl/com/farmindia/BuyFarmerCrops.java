...
public class BuyFarmerCrops extends AppCompatActivity {

    /*@Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buy_farmer_crops);
    }*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    ...
                    if (buyCropRetailerShowModel.noOfposts==0){
                    ...
                    {
                        Toast.makeText(BuyFarmerCrops.this,"the farmer hasn't posted anything yet",Toast.LENGTH_LONG).show();
                    }
                    Toast.makeText(BuyFarmerCrops.this,String.valueOf(list.size()),Toast.LENGTH_LONG).show();
        ...
        adapter = new CustomAdapterBuyCrops(list,BuyFarmerCrops.this);
